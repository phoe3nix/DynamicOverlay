...
#ifndef OVERLAYCONTAINER_SWIFT_H
#define OVERLAYCONTAINER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="OverlayContainer",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// the <code>OverlayContainerSheetPresentationController</code> class to see if it can be adapted to your presentation behavior.
SWIFT_CLASS("_TtC16OverlayContainer38OverlayContainerPresentationController")
@interface OverlayContainerPresentationController : UIPresentationController
...
/// An <code>OverlayContainerPresentationController</code> subclass that can be used to manage the transition animations and the presentation of overlay containers onscreen.
...
SWIFT_CLASS("_TtC16OverlayContainer43OverlayContainerSheetPresentationController")
@interface OverlayContainerSheetPresentationController : OverlayContainerPresentationController
- (void)presentationTransitionWillBegin;
...
/// A <code>OverlayContainerViewController</code> is a container view controller that manages one or more
...
SWIFT_CLASS("_TtC16OverlayContainer30OverlayContainerViewController")
...
/// Use <code>PassThroughView</code> whenever you need to provide a backdrop view to an <code>OverlayContainerViewController</code>.
SWIFT_CLASS("_TtC16OverlayContainer15PassThroughView")
...
/// An <code>OverlayContainerSheetDimmingView</code> class that coordinates its alpha value alongside the container presentation animations
/// and the presented overlay translations.
SWIFT_CLASS("_TtC16OverlayContainer43TransparentOverlayContainerSheetDimmingView")
@interface TransparentOverlayContainerSheetDimmingView : UIView
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
